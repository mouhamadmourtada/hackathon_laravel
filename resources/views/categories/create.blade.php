            ...
            <form action="{{ route('categories.store') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <div class="flex flex-wrap w-full justify-evenly">
                    ...
                    <div class="flex-grow mb-4 mr-2">
                        ...
                        <x-input id="libelle" class="block w-full focus:border-secondaire enlever_shadow rounded px-2 py-0.75 shadow-secondaire text-sm border-2 " type="text" name="libelle" :value="old('libelle')" required autofocus autocomplete="libelle" />
                        @error('libelle')
              ...
              <div class="flex items-center justify-end">
                <button class="items-center flex bg-secondaire hover:bg-white hover:text-secondaire text-white font-bold py-1 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">
