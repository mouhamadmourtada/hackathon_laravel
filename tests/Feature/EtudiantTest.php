...
class EtudiantTest extends TestCase
{
    ...
    public function testViewAllEtudiantsSuccessfully(): void
    {
        $this->markTestIncomplete('This test case needs review.');
        ...
        $this->json('GET', $this->endpoint)
             ...
             ->assertSee(Etudiant::find(rand(1, 5))->name);
    }

    public function testViewAllEtudiantsByFooFilter(): void
    {
        $this->markTestIncomplete('This test case needs review.');
    ...
    public function testRestoreEtudiant(): void
    {
        $this->markTestIncomplete('This test case needs review.');
    ...
    public function testPermanentEtudiant(): void
    {
        $this->markTestIncomplete('This test case needs review.');
